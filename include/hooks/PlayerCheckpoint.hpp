...
namespace persistenceAPI {
	...
	protected:
		friend void operator>>(persistenceAPI::Stream& i_stream, PAPlayerCheckpoint& o_value);
		friend void operator<<(persistenceAPI::Stream& o_stream, PAPlayerCheckpoint& i_value);
