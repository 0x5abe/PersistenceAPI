...
namespace persistenceAPI {
	...
	public:
		...
		template <>
		SABE_PA_DLL void load<GradientTriggerObject>(persistenceAPI::InputStream& i_stream);

		template <>
		SABE_PA_DLL void save<GradientTriggerObject>(persistenceAPI::OutputStream& o_stream);
