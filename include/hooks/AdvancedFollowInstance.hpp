...
namespace persistencyUtils {
	...
	protected:
		friend void operator>>(persistencyUtils::InputStream& i_stream, PUAdvancedFollowInstance& o_value);
		friend void operator<<(persistencyUtils::OutputStream& o_stream, PUAdvancedFollowInstance& i_value);
