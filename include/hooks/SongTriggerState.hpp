...
namespace persistenceUtils {
	...
	protected:
		friend void operator>>(persistenceUtils::InputStream& i_stream, PUSongTriggerState& o_value);
		friend void operator<<(persistenceUtils::OutputStream& o_stream, PUSongTriggerState& i_value);
