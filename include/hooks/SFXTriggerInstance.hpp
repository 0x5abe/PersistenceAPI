...
namespace persistencyUtils {
	...
	protected:
		friend void operator>>(persistencyUtils::InputStream& i_stream, PUSFXTriggerInstance& o_value);
		friend void operator<<(persistencyUtils::OutputStream& o_stream, PUSFXTriggerInstance& i_value);
