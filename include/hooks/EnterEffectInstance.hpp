...
namespace persistencyUtils {
	...
	protected:
		friend void operator>>(persistencyUtils::InputStream& i_stream, PUEnterEffectInstance& o_value);
		friend void operator<<(persistencyUtils::OutputStream& o_stream, PUEnterEffectInstance& i_value);
