...
void PAKeyframeObject::load(InputStream& i_stream) {
	i_stream >> *this;
}

void PAKeyframeObject::save(OutputStream& o_stream) {
	o_stream << *this;
}
...
inline void persistenceAPI::operator<<(OutputStream& o_stream, PAKeyframeObject& i_value) {
