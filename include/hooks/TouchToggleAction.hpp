...
namespace persistenceAPI {
	...
	protected:
		friend void operator>>(persistenceAPI::Stream& i_stream, PATouchToggleAction& o_value);
		friend void operator<<(persistenceAPI::Stream& o_stream, PATouchToggleAction& i_value);
