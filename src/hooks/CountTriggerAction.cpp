...
inline void persistencyUtils::operator>>(InputStream& i_stream, PUCountTriggerAction& o_value) {
...
inline void persistencyUtils::operator<<(OutputStream& o_stream, PUCountTriggerAction& i_value) {
