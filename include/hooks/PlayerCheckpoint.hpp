...
namespace persistencyUtils {
	...
	protected:
		friend void operator>>(persistencyUtils::InputStream& i_stream, PUPlayerCheckpoint& o_value);
		friend void operator<<(persistencyUtils::OutputStream& o_stream, PUPlayerCheckpoint& i_value);
