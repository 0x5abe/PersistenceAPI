...
namespace persistencyUtils {
	...
	protected:
		friend void operator>>(persistencyUtils::InputStream& i_stream, PUTimerTriggerAction& o_value);
		friend void operator<<(persistencyUtils::OutputStream& o_stream, PUTimerTriggerAction& i_value);
