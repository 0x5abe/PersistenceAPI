...
namespace persistencyUtils {
	...
	protected:
		friend void operator>>(persistencyUtils::InputStream& i_stream, PUFMODSoundState& o_value);
		friend void operator<<(persistencyUtils::OutputStream& o_stream, PUFMODSoundState& i_value);
