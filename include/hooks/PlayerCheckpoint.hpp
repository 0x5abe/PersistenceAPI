...
namespace persistenceAPI {
	...
	protected:
		friend void operator>>(persistenceAPI::InputStream& i_stream, PAPlayerCheckpoint& o_value);
		friend void operator<<(persistenceAPI::OutputStream& o_stream, PAPlayerCheckpoint& i_value);
