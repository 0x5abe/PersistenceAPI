...
namespace persistencyUtils {
	...
	public:
		friend void operator>>(persistencyUtils::InputStream& i_stream, PUDynamicObjectAction& o_value);
		friend void operator<<(persistencyUtils::OutputStream& o_stream, PUDynamicObjectAction& i_value);
