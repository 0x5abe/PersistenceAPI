...
namespace persistencyUtils {
	...
	protected:
		friend void operator>>(persistencyUtils::InputStream& i_stream, PUGroupCommandObject2& o_value);
		friend void operator<<(persistencyUtils::OutputStream& o_stream, PUGroupCommandObject2& i_value);
