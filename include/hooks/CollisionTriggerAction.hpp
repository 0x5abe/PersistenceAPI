...
namespace persistenceUtils {
	...
	protected:
		friend void operator>>(persistenceUtils::InputStream& i_stream, PUCollisionTriggerAction& o_value);
		friend void operator<<(persistenceUtils::OutputStream& o_stream, PUCollisionTriggerAction& i_value);
