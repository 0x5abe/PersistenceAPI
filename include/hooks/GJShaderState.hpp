...
namespace persistencyUtils {
	...
	protected:
		friend void operator>>(persistencyUtils::InputStream& i_stream, PUGJShaderState& o_value);
		friend void operator<<(persistencyUtils::OutputStream& o_stream, PUGJShaderState& i_value);
