...
namespace persistencyUtils {
	...
	public:
		...
		template <>
		SABE_PU_DLL void load<GradientTriggerObject>(persistencyUtils::InputStream& i_stream);

		template <>
		SABE_PU_DLL void save<GradientTriggerObject>(persistencyUtils::OutputStream& o_stream);
