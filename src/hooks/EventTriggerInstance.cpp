...
inline void persistencyUtils::operator>>(InputStream& i_stream, PUEventTriggerInstance& o_value) {
...
inline void persistencyUtils::operator<<(OutputStream& o_stream, PUEventTriggerInstance& i_value) {
