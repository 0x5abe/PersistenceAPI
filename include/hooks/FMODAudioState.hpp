...
namespace persistencyUtils {
	...
	protected:
		friend void operator>>(persistencyUtils::InputStream& i_stream, PUFMODAudioState& o_value);
		friend void operator<<(persistencyUtils::OutputStream& o_stream, PUFMODAudioState& i_value);
