...
namespace persistencyUtils {
	...
	protected:
		friend void operator>>(persistencyUtils::InputStream& i_stream, PUKeyframeObject& o_value);
		friend void operator<<(persistencyUtils::OutputStream& o_stream, PUKeyframeObject& i_value);
