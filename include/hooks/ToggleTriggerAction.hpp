...
namespace persistenceAPI {
    ...
    protected:
        friend void operator>>(persistenceAPI::Stream& i_stream, PAToggleTriggerAction& o_value);
        friend void operator<<(persistenceAPI::Stream& o_stream, PAToggleTriggerAction& i_value);
