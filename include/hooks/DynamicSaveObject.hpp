...
namespace persistencyUtils {
	...
	public:
		friend void operator>>(persistencyUtils::InputStream& i_stream, PUDynamicSaveObject& o_value);
		friend void operator<<(persistencyUtils::OutputStream& o_stream, PUDynamicSaveObject& i_value);
