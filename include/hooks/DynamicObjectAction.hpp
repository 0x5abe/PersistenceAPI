...
namespace persistenceAPI {
	...
	public:
		friend void operator>>(persistenceAPI::InputStream& i_stream, PADynamicObjectAction& o_value);
		friend void operator<<(persistenceAPI::OutputStream& o_stream, PADynamicObjectAction& i_value);
