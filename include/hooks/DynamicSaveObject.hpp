...
namespace persistenceAPI {
	...
	public:
		friend void operator>>(persistenceAPI::InputStream& i_stream, PADynamicSaveObject& o_value);
		friend void operator<<(persistenceAPI::OutputStream& o_stream, PADynamicSaveObject& i_value);
